...
### 备注 / 批注
选中文字后点击工具栏或气泡菜单里的 **备注** 按钮，即可给一句话添加备注标记；点击正文里的标记时，会在附近弹出悬浮批注。备注不会混入正文；导出时可以选择正文版或批注版，其中 DOCX 批注版会生成 Word / WPS 可识别的原生批注。
...
#### 🤖 AI 伙伴
- [Claude Opus 4.6](https://www.anthropic.com/) (Thinking) — 主力编程助手：架构、实现、调试
